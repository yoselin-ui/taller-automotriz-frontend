        ...
        {serviciosFiltrados.length > 0 ? (
          serviciosFiltrados.map((servicio) => (
            <div
              ...
              className={`service-card ${!servicio.activo ? "inactive" : ""}`}
            >
              ...
              <div className="service-actions">
                ...
                <button
                  className={
                    servicio.activo ? "btn-deactivate" : "btn-activate"
                  }
                  onClick={() => handleToggle(servicio.id_servicio)}
                >
                  {servicio.activo ? "🔒" : "✅"}
                </button>
                <button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <input
                    type="number"
                    value={formData.tiempo_est}
                    onChange={(e) =>
                      setFormData({ ...formData, tiempo_est: e.target.value })
                    }
                  />
                </div>
              </div>
